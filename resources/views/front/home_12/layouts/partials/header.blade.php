                ...
                <div class="col-lg-12">
                    <div class="header-transparent-main-wrapper">
                        <a href="index.html" class="logo">
                            <img src="{{ asset('front/assets/images/logo/02.svg') }}" alt="transparent">
                        </a>
                        <div class="nav-area">
    <ul class="">
                                ...
                                <ul class="mega-menu-item parent-nav">
                                    <li>
                                        <a href="service-details.html">
                                            <div class="single-service-menu">
                                                <div class="icon">
                                                    <img src="{{ asset('front/assets/images/service/04.svg') }}" alt="service">
                                                </div>
                                                <div class="info">
                                    ...
                                    <li>
                                        <a href="service-details-2.html">
                                            <div class="single-service-menu">
                                                <div class="icon">
                                                    <img src="{{ asset('front/assets/images/service/05.svg') }}" alt="service">
                                                </div>
                                                <div class="info">
                                    ...
                                    <li>
                                        <a href="service-details-3.html">
                                            <div class="single-service-menu">
                                                <div class="icon">
                                                    <img src="{{ asset('front/assets/images/service/06.svg') }}" alt="service">
                                                </div>
                                                <div class="info">
                                ...
                                <ul class="mega-menu-item parent-nav">
                                    <li>
                                        <a href="service-details-4.html">
                                            <div class="single-service-menu">
                                                <div class="icon">
                                                    <img src="{{ asset('front/assets/images/service/07.svg') }}" alt="service">
                                                </div>
                                                <div class="info">
                                    ...
                                    <li>
                                        <a href="service-details-5.html">
                                            <div class="single-service-menu">
                                                <div class="icon">
                                                    <img src="{{ asset('front/assets/images/service/12.svg') }}" alt="service">
                                                </div>
                                                <div class="info">
