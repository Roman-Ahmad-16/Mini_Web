                        ...
                        <form action="{{ route('admin.testimonial-section.store') }}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea id="description" class="form-control" name="description" rows="3" placeholder="Enter Description">{{ old('description') }}</textarea>
                                    @error('description')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
        ...
        <div class="row mb-3 detail-group border rounded p-2">
            ...
            <div class="col-md-3 mb-3">
                ...
                <div class="input-group input-group-sm">
                    ...
                    <input type="file" class="form-control form-control-sm" name="details[${detailIndex}][image]" required>
                </div>
            </div>
            ...
            <div class="col-md-3 mb-3">
                ...
                <div class="input-group input-group-sm">
                    ...
                    <input type="text" class="form-control" name="details[${detailIndex}][designation]" placeholder="Enter Designation">
                </div>
            </div>
            ...
            <div class="col-md-12 mb-3">
                ...
                <textarea class="form-control" name="details[${detailIndex}][feedback]" rows="2" placeholder="Enter Feedback" required></textarea>
            </div>
        </div>
    `);
        detailIndex++;
