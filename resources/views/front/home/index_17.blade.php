...
@section('content')
    ...
    <body class="color-yellow-demo demo-seo">



        <!-- rts banner area start -->
        <div class="rts-banner-area-start banner-seo rts-section-gapBottom pt--80 ">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="banner-area-seo-agency">
                            <h1 class="title">Expert SEO Solutions <br>
                                to Grow Your Business</h1>
                            <p class="disc">
                                Trusted By Over 10,000 Customer Worldwide
                            </p>
                            <div class="brand-wrapper">
                                <div class="swiper mySwiper-brand-banner" dir="ltr">
                            ...
                            <div class="bottom-right-image">
                                <img src="assets/images/banner/32.webp" alt="banner">
                            </div>
                        </div>
                        <div class="stars-area-bottom">
        ...
        <!-- service area start -->
        <div class="our-service-area-start bg_color-dark-1 rts-section-gap">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
        ...
        <div class="rts-counter-area-start">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="counter-main-wrapper-inner-seo">
                            <div class="row g-5">
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <div class="single-counter-wrapper">
                                        ...
                                        <span class="pre">Successful Projects</span>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <div class="single-counter-wrapper">
                                        <div class="icon">
                                            <img src="assets/images/service/14.svg" alt="">
                                        </div>
                                        <h2 class="counter title"><span class="odometer" data-count="650">00</span>+
                                        </h2>
                                        <span class="pre">Media Activities</span>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <div class="single-counter-wrapper">
                                        ...
                                        <span class="pre">Skilled Experts</span>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <div class="single-counter-wrapper">
                                        ...
                                        <span class="pre">Happy Clients</span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <!-- why chgoose us section start -->
        <div class="why-chooseus-area rts-section-gapTop">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <div class="floating-div-23">
                            <div class="row align-items-center">
                                <div class="col-lg-6 mt_md--50 mt_sm--50 pb_md--50 pb_sm--40">
                                    <div class="why-choose-8-wrapper-content">
                                        ...
                                        <p class="disc">
                                            Porttitor ornare fermentum aliquam pharetra ut facilisis gravida risus best
                                            suscipit. dui
                                            feugiat fusce conubia ridiculus tristique parturient gilmpci for forgettn meet
                                            natoque vulputate risu.
                                        </p>
                                        <div class="feature-between-flex">
                                            <div class="single-feature-service-wrapper-8">
                                                <div class="icon">
                                                    <img src="assets/images/why-choose/icons/08.svg" alt="service">
                                                </div>
                                                <div class="inner-wrapper">
                                                    <h4 class="title">Always On Time</h4>
                                                    <p class="disc">
                                                        Fusce condimentum mattis placerat odio donec lacus porta torquent,
                                            ...
                                            <div class="single-feature-service-wrapper-8">
                                                <div class="icon">
                                                    <img src="assets/images/why-choose/icons/09.svg" alt="service">
                                                </div>
                                                <div class="inner-wrapper">
                                ...
                                <div class="col-lg-6 pr--30">
                                    <div class="thumbnail-accountent-why-choose style-two">
                                        <img src="assets/images/why-choose/13.webp" alt="why-chooseus-area">
        ...
        <div class="rts-testimonials-area-wrapper rts-section-gap bg_testimonials-6 bg_image testimonials-seo-17">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                        <div class="floating-div-23">
                            <div class="testimonails-main-wraqpper-6">
                                <div class="swiper mySwiper-testimoanils-6 seo-testimonials" dir="ltr">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="single-testimonials-6">
                                                <div class="top">
                                                    ...
                                                    <p class="disc">
                                                        “Dictum egravida praimis rhoncus maecenas qismart curae mauris
                                                        turpis
                                                        quisque ad
                                                        dictumst
                                                ...
                                                <div class="botton-content">
                                                    <div class="avatar-area">
                                                        <div class="thumbnail">
                                                            <img src="assets/images/testimonials/avatar/04.webp"
                                                                alt="avatar">
                                                        </div>
                                                        <div class="inner">
                ...
                <div class="row g-5 mt--20">
                    ...
                    <div class="col-lg-12">
                        <div class="blog-swiper-main-wrapper-10">
                            <div class="swiper mySwiper-blog-10 pb--70" dir="ltr">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
