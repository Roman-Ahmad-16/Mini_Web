...
@section('title', 'Home')
 <!-- partners area breadcrumb area wrapper -->
    ...
    <div class="project-details-wrapper-image-top rts-section-gap">
        <section id="gallery">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 image">
                            <div class="img-wrapper">
                                <a href="assets/images/project/20.jpg"><img alt="images"
                                        src="assets/images/project/20.jpg" class="img-responsive"></a>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 image">
                            <div class="img-wrapper">
                                <a href="assets/images/project/21.jpg"><img alt="images"
                                        src="assets/images/project/21.jpg" class="img-responsive"></a>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 image">
                            <div class="img-wrapper">
                                <a href="assets/images/project/22.jpg"><img alt="images"
                                        src="assets/images/project/22.jpg" class="img-responsive"></a>
                                <div class="img-overlay" style="opacity: 0;">
                                    <i class="fa fa-plus-circle" aria-hidden="true"></i>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 image">
                            <div class="img-wrapper">
                                <a href="assets/images/project/23.jpg"><img alt="images"
                                        src="assets/images/project/23.jpg" class="img-responsive"></a>
                                <div class="img-overlay" style="opacity: 0;">
                                    <i class="fa fa-plus-circle" aria-hidden="true"></i>
                                </div>
                            </div>
            ...
            <div id="overlay" style="display: none;">
                <div id="prevButton"><i class="fa fa-chevron-left"></i></div><img alt="images"
                    src="assets/images/project/23.jpg">
        ...
        <div class="container mt--30">
            <div class="row g-0">
                <div class="col-lg-12">
                    <div class="thumbnail with-video-area mb--25">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="counterup-area-project-details">
                        <div class="single-counter-up-area">
                            <div class="icon">
                                <img src="assets/images/portfolio/icons/05.svg" alt="portfolio">
                            </div>
                        ...
                        <div class="single-counter-up-area with-pl">
                            <div class="icon">
                                <img src="assets/images/portfolio/icons/06.svg" alt="portfolio">
                            </div>
                        ...
                        <div class="single-counter-up-area with-pl">
                            <div class="icon">
                                <img src="assets/images/portfolio/icons/07.svg" alt="portfolio">
                            </div>
                        ...
                        <div class="single-counter-up-area with-pl b-n">
                            <div class="icon">
                                <img src="assets/images/portfolio/icons/08.svg" alt="portfolio">
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="next-prev-project-wrapper">
                        <div class="single-next-prev-wrapper">
                            ...
                            <div class="info">
                                <span>Building</span>
                                <p>Quality Construction Projects That
    ...
    <div class="rts-gallery-area rts-section-gapBottom">
                ...
                <div class="col-lg-12">
                    <div class="title-area-between-wrapper-gallery-project">
                        <div class="title-style-two mb--40 left">
                            ...
                            <span class="pre">Related Projects</span>
