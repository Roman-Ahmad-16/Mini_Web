                        ...
                        <div class="main-header">
                                                    ...
                                                    <div class="row g-0">
                                                        <div class="col-lg-3">
                                                            <ul class="mega-menu-item with-list parent-nav">
                                                                ...
                                                                <li><a href="{{ route('front.index_3') }}"><i
                                                                            class="fa-sharp fa-regular fa-chevron-right"></i>
                                                                        Index Three</a></li>
                                                                <li><a href="{{ route('front.index_4') }}"><i
                                                                            class="fa-sharp fa-regular fa-chevron-right"></i>
                                                                        Business Four</a></li>
                                                                <li><a href="{{ route('front.index_5') }}"><i
                                                                            class="fa-sharp fa-regular fa-chevron-right"></i>
                                                                        Finance Demo</a></li>
                                                                <li><a href="{{ route('front.index_6') }}"><i
                                                                            class="fa-sharp fa-regular fa-chevron-right"></i>
                                                                        Marketing agency</a></li>
                                                                <li><a href="{{ route('front.index_7') }}">
                                                                        <i
                                                                            class="fa-sharp fa-regular fa-chevron-right"></i>
                                                                        Accountent One
                                                                ...
                                                                <li><a href="{{ route('front.index_10') }}">
                                                                        <i
                                                                            class="fa-sharp fa-regular fa-chevron-right"></i>
                                                                        Business Investment
                                                                        <span class="new-badge">New</span>
                                                        ...
                                                        <div class="col-lg-3">
                                                            <ul class="mega-menu-item with-list parent-nav">
                                                                ...
                                                                <li><a href="{{ route('front.index_11') }}"><i
                                                                            class="fa-sharp fa-regular fa-chevron-right"></i>
                                                                        Business agency</a></li>
                                                                <li><a href="{{ route('front.index_12') }}"><i
                                                                            class="fa-sharp fa-regular fa-chevron-right"></i>
                                                                        Business Management</a></li>
                                                                <li><a href="{{ route('front.index_13') }}">
                                                                        <i
                                                                            class="fa-sharp fa-regular fa-chevron-right"></i>
                                                                        Business Coach
                                                                        <span class="new-badge">New</span>
                                                                ...
                                                                <li><a href="{{ route('front.index_14') }}"><i
                                                                            class="fa-sharp fa-regular fa-chevron-right"></i>
                                                                        Insurance Home</a></li>
                                                                <li><a href="{{ route('front.index_15') }}"><i
                                                                            class="fa-sharp fa-regular fa-chevron-right"></i>
                                                                        Business Website</a></li>
                                                                <li><a href="{{ route('front.index_16') }}"><i
                                                                            class="fa-sharp fa-regular fa-chevron-right"></i>
                                                                        Business Parallax</a></li>
                                                                <li><a href="{{ route('front.index_17') }}"><i
                                                                            class="fa-sharp fa-regular fa-chevron-right"></i>
                                                                        Business Video</a></li>
                                                                <li><a href="{{ route('front.index_18') }}">
                                                                        <i
                                                                            class="fa-sharp fa-regular fa-chevron-right"></i>
                                                                        Accountent Two
                                                                        <span class="new-badge">New</span>
                                                                ...
                                                                <li><a href="{{ route('front.index_19') }}">
                                                                        <i
                                                                            class="fa-sharp fa-regular fa-chevron-right"></i>
                                                                        Technology Demo
                                                                        <span class="new-badge">New</span>
                                                    ...
                                                    <div class="row g-5">
                                                            ...
                                                            <ul class="mega-menu-item parent-nav">
                                                                ...
                                                                <li>
                                                                    <a href="contact.html" class="free-consultation">
                                                                        <div class="single-service-menu">
                                                                            <div class="info">
                                                                                <h5 class="title">Get Free Consultation
                                                                                </h5>
                                                                                <p class="details">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="menu-thumb pl--20">
                                                                <img src="{{ asset('front/assets/images/banner/24.webp') }}"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="button-area">
                                ...
                                <button id="menu-btn" aria-label="Menu" class="menu-btn menu ml--20 ml_sm--5">
                                    <img class="menu-light" src="{{ asset('front/assets/images/icons/01.svg') }}"
                                        alt="Menu-icon">
                                </button>
                            </div>
                        </div>
