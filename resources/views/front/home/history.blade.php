...
@section('title', 'Home')
 <!-- about us area wrapper main -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-area-left center">
                        <span class="bg-title">Our history</span>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="title-style-two left">
                        <h2 class="title rts-text-anime-style-1">Our Journey: From Vision to Reality, and Beyond.
                        </h2>
                        <p class="disc">
                            Dabus nisl aliquet congue tellus nascetur lectus sagpien mattis arcu dictums augue volutpat
                            felis etiam
                        </p>
                        <img class="mt--70 shape-iamge-line" src="assets/images/appoinment/01.svg" alt="appoinment">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="company-history-main-wrapper">
                        <div class="single-company-history">
                            <div class="left">
                                <h5 class="title">Elevate Web Design</h5>
                                <p class="disc">
                            ...
                            <div class="right">
                                <h6 class="title-year">2022</h6>
                            </div>
                        </div>
                        <div class="single-company-history">
                            <div class="left">
                                <h5 class="title">WebFoundry Solutions</h5>
                                <p class="disc">
                                    Neque partrient sed nascetur facilisis suscipit ridiculus magna lobortis imperdiet
                                    vivamus est aliquam euismod nector quam convallis ornare justo service visionary
                                    sources
                            ...
                            <div class="right">
                                <h6 class="title-year">2020</h6>
                            </div>
                        </div>
                        <div class="single-company-history">
                            <div class="left">
                                <h5 class="title">BrightPath Creations</h5>
                                <p class="disc">
                                    Neque partrient sed nascetur facilisis suscipit ridiculus magna lobortis imperdiet
                                    vivamus est aliquam euismod nector quam convallis ornare justo service visionary
                                    sources
                            ...
                            <div class="right">
                                <h6 class="title-year">2016</h6>
                            </div>
                        </div>
                        <div class="single-company-history">
                            <div class="left">
                                <h5 class="title">BoldFrame Designs</h5>
                                <p class="disc">
                                    Neque partrient sed nascetur facilisis suscipit ridiculus magna lobortis imperdiet
                                    vivamus est aliquam euismod nector quam convallis ornare justo service visionary
                                    sources
    ...
    <div class="rts-testimonails-area-main rts-section-gapTop">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row mt--45">
                <div class="col-lg-12">
                    <div class="swiper mySwiper-testimoanils-7">
