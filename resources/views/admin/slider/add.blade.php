                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route('admin.slider.store') }}" method="POST"
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label control-label">{{ __('Title') }} <span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label control-label">{{ __('Sub Title') }}</label>
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="sub_title"
                                                placeholder="{{ __('Sub Title') }}" value="{{ old('sub_title') }}">
                                        </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label control-label">{{ __('Button Title') }}</label>
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-mouse-pointer"></i></span>
                                            </div>
                                            <input type="text" class="form-control form-control-sm" name="button_title"
                                                placeholder="{{ __('Button Title') }}" value="{{ old('button_title') }}">
                                        </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label control-label">{{ __('Button URL') }}</label>
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-link"></i></span>
                                            </div>
                                            <input type="url" class="form-control form-control-sm" name="button_url"
                                                placeholder="{{ __('Button URL') }}" value="{{ old('button_url') }}">
                                        </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label control-label">{{ __('Order No') }} <span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                            ...
                                            <input type="number" class="form-control form-control-sm" name="serial_no"
                                                placeholder="{{ __('Order') }}" value="{{ old('serial_no') }}">
                                        </div>
                                ...
                                <div class="form-group row">
                                    <label for="status" class="col-sm-2 col-form-label control-label">{{ __('Status') }}
