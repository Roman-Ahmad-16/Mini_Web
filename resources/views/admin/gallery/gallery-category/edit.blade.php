                        ...
                        <form class="form-horizontal" action="{{ route('admin.gcategory.update', $gcategory->id) }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="{{ __('Name') }}" value="{{ old('name', $gcategory->name) }}"></div>
                                    @if ($errors->has('name'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="number" class="form-control" name="serial_number" placeholder="{{ __('Serial No') }}" value="{{ old('serial_number', $gcategory->serial_number) }}"></div>
