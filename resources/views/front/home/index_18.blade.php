...
@section('content')
    ...
    <body class="color-yellow-demo demo-technology">
        ...
        <div class="rts-technology-banner-area bg_image rts-section-gap d-flex align-items-center">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="inner-content-technology-banner">
                            <h1 class="title">Smart Solutions for
                                a Digital World</h1>
                            <p class="disc">
                                At Technology we harness the power of cutting edge technology to build smart, scalable, and
                                secure solutions for the digital age
                            </p>
                            <div class="button-wrapper">
                                <a href="#" class="rts-btn btn-primary">Get started</a>
                                <a href="#" class="rts-btn btn-primary btn-border">Our Service</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- large-image-banner-bottom -->
        <div class="large-image-banner-bottom mt-dec-large-img-b-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="large-image-with-rating">
                            <div class="large-image-clip-path-technology">
                                <img src="{{ asset('front/assets/images/banner/34.webp') }}" alt="">
                            </div>
                            <div class="rating-area-top-left-technology">
                                <ul>
                                ...
                                <img src="{{ asset('front/assets/images/banner/01.svg') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- large-image-banner-bottom end -->


        <!-- rts service technocal area start -->
        <div class="rts-service-technical-area rts-section-gap">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                ...
                <div class="row g-5 mt--10">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="single-service-technical-area">
                            <div class="icon">
                                <img src="{{ asset('front/assets/images/service/17.svg') }}" alt="icon">
                            </div>
                            <a href="#">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="single-service-technical-area">
                            <div class="icon">
                                <img src="{{ asset('front/assets/images/service/18.svg') }}" alt="icon">
                            </div>
                            <a href="#">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="single-service-technical-area">
                            <div class="icon">
                                <img src="{{ asset('front/assets/images/service/19.svg') }}" alt="icon">
                            </div>
                            <a href="#">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="single-service-technical-area">
                            <div class="icon">
                                <img src="{{ asset('front/assets/images/service/20.svg') }}" alt="icon">
                            </div>
                            <a href="#">
                                <h5 class="title">Technology Solutions</h5>
                            </a>
                            <p class="disc">
                                Fusce dignissim erat dis proin ornare class sem nibh
                            </p>
        ...
        <!-- rts service technocal area end -->
