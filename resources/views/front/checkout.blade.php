            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-area-left center">
                        <span class="bg-title">Checkout</span>
                        <h1 class="title">
                            Checkout
                        </h1>
                    </div>
                ...
                <div class="ms-default-page container entry-content">
                    <div class="woocommerce">
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <button class="add-btn rts-btn btn-primary" type="submit">Apply
                                                Coupon</button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <form name="checkout" method="post"
                            class="checkout woocommerce-checkout ms-woocommerce-checkout" action="#"
                                    ...
                                    <div class="full-grid">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="hnumber-2" name="hnumber"
                                        ...
                                        <div class="ordered-product">
                                            ...
                                            <table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>Safety Helmet <strong><i class="fa fa-close"></i> 1</strong>
                                                        </td>
                                                        <td>$30.00</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Sledge Hammer <strong><i class="fa fa-close"></i> 1</strong>
                                                        </td>
                                                        <td>$30.00</td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <div class="payment-method mt-40 md-mt-20">
                                            <div class="top-area">
                                                <div class="payment-co"><span>PayPal</span> <img
                                                        src="assets/images/paypal.png" alt="PayPal Logo"></div>
                                                <div class="p-msg">Pay via PayPal you can pay with your credit card if
                                                    you dont have a
                                                    PayPal account.</div>
                                            </div>
                                            <div class="bottom-area">
                                                <p class="mt-15">Your personal data will be used to process your order,
                                                    support your
                                                    experience throughout this website, and for other purposes described
                                                    in our privacy
                                                    policy.</p>
                                                <button class="add-btn rts-btn btn-primary" type="submit">Continue to
                                                    payment</button>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <tbody>
                                                    ...
                                                    <td colspan="2">
                                                        <div class="ms-checkout-product">
                                                            <div class="ms-checkout-product__thumbnail">
                                                                <img src="assets/images/shop/shop-01.jpg"
                                                                    class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                                                    alt="Shop Image">
                                                            </div>
                                                            <div class="ms-checkout-product__content">
                                                                <h5>Run Max 88 <span class="product-quantity">× 1</span>
                                                                </h5>
                                                ...
                                                <tr class="cart_item">
                                                    <td colspan="2">
                                                        <div class="ms-checkout-product">
                                                            <div class="ms-checkout-product__thumbnail">
                                                                <img src="assets/images/shop/shop-02.jpg"
                                                                    class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                                                    alt="Shop Image">
                                                            </div>
                                                            <div class="ms-checkout-product__content">
                                                                <h5>Workout Revolution 2 <span
                                                                        class="product-quantity">× 1</span></h5>
                                                                <span class="woocommerce-Price-amount amount"><bdi><span
                                                                            class="woocommerce-Price-currencySymbol">$</span>180.00</bdi></span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr class="cart_item">
                                                    <td colspan="2">
                                                        <div class="ms-checkout-product">
                                                            <div class="ms-checkout-product__thumbnail">
                                                                <img src="assets/images/shop/shop-03.jpg"
                                                                    class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                                                                    alt="Shop Image">
                                                            </div>
                                                            <div class="ms-checkout-product__content">
                                                                <h5>KL 17 BS <span class="product-quantity">× 1</span>
                                                                </h5>
                                                                <span class="woocommerce-Price-amount amount">
                                                                    <bdi><span
                                                                            class="woocommerce-Price-currencySymbol">$</span>80.00</bdi>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <div class="woocommerce-terms-and-conditions-wrapper">
                                                    <div class="woocommerce-privacy-policy-text">
                                                        <p>Your personal data will be used to process your order,
                                                            ...
                                                            <a href="#0" class="woocommerce-privacy-policy-link"
