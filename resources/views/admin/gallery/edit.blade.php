                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route('admin.gallery.update', $gallery->id) }}"
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-sm-2 control-label">{{ __('image') }}<span
                                ...
                                <div class="form-group row">
                                    <label for="bcategory_id" class="col-sm-2 control-label">{{ __('Category') }}<span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-sm-2 control-label">{{ __('Serial No') }}<span
                                            class="text-danger">*</span></label>
