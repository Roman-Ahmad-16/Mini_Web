    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group input-group-sm">
                ...
                <input type="number" name="order_no" id="order_no" class="form-control form-control-sm"
  ...
  <div class="col-md-8">
    <div class="form-group">
        ...
        <div class="input-group input-group-sm">
            ...
            <input type="text" name="feedback" id="feedback" class="form-control" value="{{ $testimonial->feedback }}" required>
        </div>
        @error('feedback')
